...
echo ^<head^> >>a.html
echo ^<title^>list^</title^> >>a.html
echo ^<style type=text/css^> >>a.html
echo div{width:54.125^%%;} >>a.html
echo div{margin^:auto^;} >>a.html
echo img{display^:block^;margin^:auto;} >>a.html
echo img{padding^:2px 22px; height^:200px; float^:left;} >>a.html
echo img{border^:0 red solid;} >>a.html
echo a:link{text-decoration: none; color:black;} >>a.html
