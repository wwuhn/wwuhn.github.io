...
<table class="table2">
  ...
  <tr>
    <td style="text-align:left;">&nbsp;<a href="addform.asp">AddRecord</a>&nbsp;<a href="list.asp">List100</a>&nbsp;<a href="search.asp">search</a></td>
    ...
    <td>本页记录：<%=(Recordset1_first)%>到<%=(Recordset1_last)%>/共<%=(Recordset1_total)%>，第<%=((Recordset1_first+11)/12)%>页/共<%=int(((Recordset1_total)+11)/12)%>页</td>
  </tr>
</table>
<table class="table1">
<colgroup>
