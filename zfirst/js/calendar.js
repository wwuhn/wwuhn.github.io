...
//节气和农历天数代码:用excel表<节气和农历天数代码>
				...
				var monthThisyear="正月;二月;三月;四月;五月;六月;七月;八月;九月;十月;十一月;十二月" ;
					monthThisyear=monthThisyear.split(";");/*该农历年月份数（有闰月时要插到变量monthThisyear到中间，如14年“闰八月”）（第5处）*/
