...
/*农历的另一年份时，需更改6处（第6处是节气更改，作为变量中的字符的"Thisyear"不更改）*/
				...
				var YDate0=new Date("1/1/2016");/*（第2处）*/
				var y70=new Date("1/1/1970");
				
				var sec0=YDate0-y70;/*1970-公历该年元旦日的豪秒数((41*365+10)*spd=1293840000000)*/
				
				var YDate1 = new Date("2/8/2016");/*（春节的公历日期；第3处）*/
				var dday = (YDate1-YDate0)/(24*60*60*1000);
				//alert(dday);
				
				var totaldayThisyear=0;
				var yearThisyear="30;29;30;29;29;30;29;30;30;29;30;30"; /*该农历年每月天数（第4处）http://www.alfeng.com/Html/?266.html*/
...
Year=today.getYear()+1900;
		...
		switch(enym){/*节气更改（第6处）http://jieqi.xpcha.com http://www.nongli.com//*/
		case "02-04":cnym=cnym+"&nbsp;"+"立春";break;
		case "02-19":cnym=cnym+"&nbsp;"+"雨水";break;
		case "03-05":cnym=cnym+"&nbsp;"+"惊蜇";break;
		case "03-20":cnym=cnym+"&nbsp;"+"春分";break;
		case "04-04":cnym=cnym+"&nbsp;"+"清明";break;
		case "04-19":cnym=cnym+"&nbsp;"+"谷雨";break;
	


		case "05-09":cnym=cnym+"&nbsp;"+"立夏";break;
		case "05-20":cnym=cnym+"&nbsp;"+"小满";break;	
