...
for /r F:\website %%h in (*.html) do @copy %%h %userprofile%\desktop\websitehtml
cd /d %ProgramFiles%\winrar
rar a -r %userprofile%\desktop\websitehtml.rar %userprofile%\desktop\websitehtml\*
python F:\Website\html.py
