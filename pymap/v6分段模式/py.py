    ...
    <script>
        ...
        var option = {
            ...
            visualMap: {
                type: 'piecewise',
                pieces: [
                    {gt: 0, lte: 25, color: '#2b88b9', label: '两湖两广两河山'},
                    {gt: 25, lte: 50, color: '#b8c418', label: '川藏云贵蒙吉安'},
                    {gt: 50, lte: 75, color: '#e8943a', label: '四市二区青甘陕'},
                    {gt: 75, lte: 100, color: '#df6a5d', label: '五江二宁福海湾'}
                ],
                left: 20,
                bottom: 40,
                calculable: true
