...
//节气和农历天数代码:用excel表<节气和农历天数代码>
				...
				var YDate0=new Date("1/1/2017");/*（第2处）*/
				var y70=new Date("1/1/1970");
				
				var sec0=YDate0-y70;/*1970-公历该年元旦日的豪秒数((41*365+10)*spd=1293840000000)*/
				
				var YDate1 = new Date("1/28/2017");/*（春节的公历日期；第3处）*/
				var dday = (YDate1-YDate0)/(24*60*60*1000);
				//alert(dday);
				
				var totaldayThisyear=0;
				var yearThisyear="29;30;29;30;29;29;30;29;30;29;30;30;30"; /*该农历年每月天数（第4处）http://www.alfeng.com/Html/?266.html*/
				...
				var monthThisyear="正月;二月;三月;四月;五月;六月;闰六月;七月;八月;九月;十月;十一月;十二月" ;
